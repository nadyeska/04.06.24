...
function moverPeao(pecaAnalisada, elementoDestino) {
    ...
    function moverTorre(torre_branca) {
          movimentoPermitido = 
      ...
      function moverTorre(pecaClicada, elementoDestino) {
        ...
        console.error("Eita! Aconteceu algum, a coisa que não deu certo finalizar as linhas de código para mover a torre. Veja o erro: ", e);
    }
